...
;
  public static foam.core.PropertyInfo COMPARATOR = new foam.core.AbstractFObjectPropertyInfo() {
...
;
  public static foam.core.PropertyInfo ARRAY = new foam.core.AbstractObjectPropertyInfo() {
      public String getName() {
        return "array";
      }
      public Object get(Object o) {
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.dao.OrderedSink").setObjClass(foam.dao.OrderedSink.class)
