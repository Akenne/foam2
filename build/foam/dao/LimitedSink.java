...
;
  public static foam.core.PropertyInfo LIMIT = new foam.core.AbstractLongPropertyInfo() {
...
;
  public static foam.core.PropertyInfo COUNT = new foam.core.AbstractIntPropertyInfo() {
      public String getName() {
        return "count";
      }
      public Object get(Object o) {
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.dao.LimitedSink").setObjClass(foam.dao.LimitedSink.class)
  ...
  public LimitedSink setLimit(long val) {
    limit_ = val;
    limitIsSet_ = true;
    return this;
  }
