...
;
  public static foam.core.PropertyInfo SKIP = new foam.core.AbstractLongPropertyInfo() {
...
;
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.dao.SkipSink").setObjClass(foam.dao.SkipSink.class)
  ...
  public SkipSink setSkip(long val) {
    skip_ = val;
    skipIsSet_ = true;
    return this;
  }
