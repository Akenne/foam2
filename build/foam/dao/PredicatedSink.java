...
;
  public static foam.core.PropertyInfo PREDICATE = new foam.core.AbstractFObjectPropertyInfo() {
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.dao.PredicatedSink").setObjClass(foam.dao.PredicatedSink.class)
