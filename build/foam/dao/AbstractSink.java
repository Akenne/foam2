...
public class AbstractSink extends foam.core.AbstractFObject implements foam.dao.Sink {
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.dao.AbstractSink").setObjClass(foam.dao.AbstractSink.class);
