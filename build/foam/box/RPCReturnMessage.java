...
;
  public static foam.core.PropertyInfo DATA = new foam.core.AbstractObjectPropertyInfo() {
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.box.RPCReturnMessage").setObjClass(foam.box.RPCReturnMessage.class)
