...
;
  public static foam.core.PropertyInfo REGISTRY = new foam.core.AbstractObjectPropertyInfo() {
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.box.BoxRegistry").setObjClass(foam.box.BoxRegistry.class)
...
;
    public static foam.core.PropertyInfo EXPORT_BOX = new foam.core.AbstractFObjectPropertyInfo() {
        public String getName() {
          return "exportBox";
        }
        public Object get(Object o) {
...
;
    public static foam.core.PropertyInfo LOCAL_BOX = new foam.core.AbstractFObjectPropertyInfo() {
        public String getName() {
          return "localBox";
        }
        public Object get(Object o) {
    ...
    private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
      .setId("Registration").setObjClass(Registration.class)
