...
;
  public static foam.core.PropertyInfo ATTRIBUTES = new foam.core.AbstractObjectPropertyInfo() {
...
;
  public static foam.core.PropertyInfo OBJECT = new foam.core.AbstractObjectPropertyInfo() {
      public String getName() {
        return "object";
      }
      public Object get(Object o) {
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.box.Message").setObjClass(foam.box.Message.class)
