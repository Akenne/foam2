...
public class False extends foam.mlang.predicate.AbstractPredicate implements foam.core.Serializable {
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.mlang.predicate.False").setObjClass(foam.mlang.predicate.False.class);
