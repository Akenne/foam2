...
;
  public static foam.core.PropertyInfo ARGS = new foam.core.AbstractPropertyInfo() {
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.mlang.predicate.Nary").setObjClass(foam.mlang.predicate.Nary.class)
