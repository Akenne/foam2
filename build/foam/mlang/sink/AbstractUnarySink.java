...
public class AbstractUnarySink extends foam.dao.AbstractSink implements foam.core.Serializable {
...
;
  public static foam.core.PropertyInfo ARG1 = new foam.core.AbstractFObjectPropertyInfo() {
      ...
      public foam.mlang.Expr get_(Object o) {
        return ((AbstractUnarySink)o).getArg1();
      }
      public void set(Object o, Object value) {
        ((AbstractUnarySink)o).setArg1(cast(value));
      }
  ...
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.mlang.sink.AbstractUnarySink").setObjClass(foam.mlang.sink.AbstractUnarySink.class)
    .addProperty(AbstractUnarySink.ARG1);
  ...
  public AbstractUnarySink setArg1(foam.mlang.Expr val) {
    arg1_ = val;
    arg1IsSet_ = true;
    return this;
  }
