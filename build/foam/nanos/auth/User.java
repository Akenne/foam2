...
public class User extends foam.core.AbstractFObject implements foam.nanos.auth.EnabledAware, foam.nanos.auth.LastModifiedAware, foam.nanos.auth.LastModifiedByAware {
  public static foam.core.PropertyInfo EMAIL = new foam.core.AbstractStringPropertyInfo() {
  ...
  public static foam.core.PropertyInfo GROUP = new foam.core.AbstractObjectPropertyInfo() {
      public String getName() {
        return "group";
      }
      public Object get(Object o) {
      ...
      public Object get_(Object o) {
        return ((User)o).getGroup();
      }
      public void set(Object o, Object value) {
        ((User)o).setGroup(cast(value));
      }
...
;
  public static foam.core.PropertyInfo SPID = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "spid";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo LAST_LOGIN = new foam.core.AbstractObjectPropertyInfo() {
      public String getName() {
        return "lastLogin";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo FIRST_NAME = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "firstName";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo MIDDLE_NAME = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "middleName";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo LAST_NAME = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "lastName";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo ORGANIZATION = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "organization";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo DEPARTMENT = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "department";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo PHONE = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "phone";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo MOBILE = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "mobile";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo LANGUAGE = new foam.core.AbstractObjectPropertyInfo() {
      public String getName() {
        return "language";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo TIME_ZONE = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "timeZone";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo PASSWORD = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "password";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo PREVIOUS_PASSWORD = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
...
;
  public static foam.core.PropertyInfo PASSWORD_LAST_MODIFIED = new foam.core.AbstractObjectPropertyInfo() {
      public String getName() {
...
;
  public static foam.core.PropertyInfo NOTE = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "note";
      }
      public Object get(Object o) {
  ...
  private boolean groupIsSet_ =     false;
;
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.nanos.auth.User").setObjClass(foam.nanos.auth.User.class)
    .addProperty(User.ID)
  ...
  public User setGroup(Object val) {
    group_ = val;
    groupIsSet_ = true;
    return this;
  }
