...
;
  public static foam.core.PropertyInfo NUMOCCURRENCES = new foam.core.AbstractIntPropertyInfo() {
...
;
  public static foam.core.PropertyInfo ID = new foam.core.AbstractObjectPropertyInfo() {
      ...
      public foam.core.CompoundKey get_(Object o) {
        return ((PMInfo)o).getId();
      }
      public void set(Object o, Object value) {
        ((PMInfo)o).setId(cast(value));
      }
...
;
  public static foam.core.PropertyInfo CLSNAME = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "clsname";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo PMNAME = new foam.core.AbstractStringPropertyInfo() {
      public String getName() {
        return "pmname";
      }
      public Object get(Object o) {
  ...
  public static foam.core.PropertyInfo MINTIME = new foam.core.AbstractLongPropertyInfo() {
      public String getName() {
        return "mintime";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo MAXTIME = new foam.core.AbstractLongPropertyInfo() {
      public String getName() {
        return "maxtime";
      }
      public Object get(Object o) {
...
;
  public static foam.core.PropertyInfo TOTALTIME = new foam.core.AbstractLongPropertyInfo() {
      public String getName() {
        return "totaltime";
      }
      public Object get(Object o) {
...
;
  private static final foam.core.ClassInfo classInfo_ = new foam.core.ClassInfoImpl()
    .setId("foam.nanos.pm.PMInfo").setObjClass(foam.nanos.pm.PMInfo.class)
    .addProperty(PMInfo.ID)
...
PMInfo.PMNAME
  ...
  public PMInfo setId(foam.core.CompoundKey val) {
    Object[] values = val.getValues();
    setClsname((String)values[0]);
    setPmname((String)values[1]);
    return this;
  }
